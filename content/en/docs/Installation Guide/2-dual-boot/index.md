...
**Bước 7:** Danh sách các phân vùng có sẵn trong máy sẽ được liệt kê trong cửa số mới xuất hiện. Các bạn cần tìm đúng phân vùng đã chia ở [Mục 3](#-Chia-phân-vùng-trên-Windows-để-cài-đặt-Ubuntu).
